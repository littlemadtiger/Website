...
<head>
    ...
    <style type="text/css" class="silex-style">
        #im {
            ...
            right: 0;
            bottom: 0;
            background-image: url('https://cdn.shopify.com/s/files/1/0982/0710/products/fractaltiger_art_preview_94266d34-2978-4e72-9472-da9ab9093d89.jpeg?v=1484946280');
    ...
    <head>
        ...
        <style>
                <body {
                <div id="wrapper"><div id="im"></div></div>.center {
                    text-align: center;
                    border: 3px solid;
                }
        </style>
